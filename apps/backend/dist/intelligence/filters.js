...
exports.parseAndValidateInfoHash = void 0;
exports.filterJunkRelease = filterJunkRelease;
const processor_js_1 = require("../prowlarr/processor.js");
Object.defineProperty(exports, "parseAndValidateInfoHash", { enumerable: true, get: function () { return processor_js_1.parseAndValidateInfoHash; } });
 ...
 */
function filterJunkRelease(title, magnetUrl, directHash) {
    const cleanTitle = title.trim();
    const lowerTitle = cleanTitle.toLowerCase();
    // 1. InfoHash validation (invalid/missing infoHash is junk)
    const infoHash = (0, processor_js_1.parseAndValidateInfoHash)(magnetUrl, directHash);
    if (!infoHash) {
